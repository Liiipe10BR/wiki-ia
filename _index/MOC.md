...
- [[Janela-de-Contexto]] — restringe → [[RAG]], [[Chunking]], [[Agente-de-IA]]; alternativa → [[Fine-tuning]]
- [[Agente-de-IA]] — depende de → [[Model-Context-Protocol]], [[RAG]], [[Janela-de-Contexto]]; relacionado a → [[Tool-Calling]]
- [[Avaliacao-de-RAG|Avaliação de RAG]] — valida → [[RAG]], [[Chunking]], [[Embeddings]]
...
- [[Roteamento-de-Modelos|Roteamento de Modelos]] — relacionado a → [[Agente-de-IA]], [[Observabilidade-de-IA]]
- [[GraphRAG]] — depende de → [[RAG]]
- [[HITL|Human-in-the-Loop]] — relacionado a → [[Guardrails]], [[Agente-de-IA]], [[Tool-Calling]]
- [[Compressao-de-Contexto|Compressão de Contexto]] — relacionado a → [[Janela-de-Contexto]], [[RAG]]
- [[Saida-Estruturada|Saída Estruturada]] — relacionado a → [[Tool-Calling]], [[Engenharia-de-Prompts]]
- [[RAG-Multimodal|RAG Multimodal]] — depende de → [[RAG]]
- [[Red-Teaming]] — relacionado a → [[Guardrails]], [[Prompt-Injection]]
- [[Reflexion]] — depende de → [[Agente-de-IA]]; relacionado a → [[Memoria-de-Agentes]]
...
- [[Self-Consistency]] — depende de → [[Chain-of-Thought]]; relacionado a → [[Engenharia-de-Prompts]]
...
Agente-de-IA ← Tool-Calling, MCP, Janela-de-Contexto, RAG
ReAct / Reflexion / CoT / Self-Consistency → raciocínio e trajetória
RLHF / DPO / Constitutional-AI / LoRA → alinhamento e adaptação
Guardrails / HITL / Red-Teaming → segurança e controle
Speculative-Decoding / Quantização / MoE → eficiência de modelo e serving
```
