...
| Item | Valor |
|---|---|
| Notas de conceito ativas | 20 (RAG, Embeddings, Model-Context-Protocol, Fine-tuning, Banco-de-Dados-Vetorial, Chunking, Janela-de-Contexto, Agente-de-IA, Avaliação-de-RAG, Proveniência-de-Dados, Reranking, Hybrid-Search, Alucinação, Tool-Calling, Prompt-Injection, Grounding, Quantização, Sistemas-Multiagente, Engenharia-de-Prompts, Observabilidade-de-IA) |
| Contribuições humanas | 3 notas iniciais + estrutura do vault |
| Contribuições de IA | 17 notas novas + revisões, fontes e CI — Claude (várias sessões) + Grok (xAI, 6ª–8ª, 10ª–16ª + Issues #15, #17 e #14) + Replit (9ª) |
...
- [x] ~~`Fontes/` foi criada mas está vazia de arquivos reais~~ — populada em
  ...
  Tool-Calling, Prompt-Injection, Grounding, Quantização, Sistemas-Multiagente, Engenharia-de-Prompts e Observabilidade-de-IA em 2026-08-30).
...
- [ ] Notas candidatas / issues em aberto: Guardrails (#12) — ver PRs paralelos se houver.
